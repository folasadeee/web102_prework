...
let displayStr = 
    `${numberOfUnfundedGames === 1 ? 
        `A total of $${totalRaised.toLocaleString("en-US")} has been raised for ${totalGames} games. Currently, ${numberOfUnfundedGames} game remains unfunded. We need your help to fund these amazing games!` 
        
        : 

        `A total of $${totalRaised.toLocaleString("en-US")} has been raised for ${totalGames} games. Currently, ${numberOfUnfundedGames} games remain unfunded. We need your help to fund these amazing games!`}`
...
description.innerText = displayStr
 ...
 * Skills used: spread opeator, destructuring, template literals, sort 
 */
